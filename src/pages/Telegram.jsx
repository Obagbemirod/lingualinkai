...
const Telegram = () => {
  ...
  const healthContent = {
    ...
    Yoruba: [
      ...
      { type: 'text', content: "Igbesẹ 1: Fi omi tó ńṣàn (tútù tàbí gbígbóná) rin ọwọ rẹ, pa robinet ná, ki o si fi ọṣẹ si ọwọ rẹ." },
      { type: 'icon', content: <Droplet className="w-8 h-8 text-blue-500" /> },
      ...
      { type: 'icon', content: <Smile className="w-8 h-8 text-yellow-500" /> },
      { type: 'text', content: "Igbesẹ 4: San ọwọ rẹ daradara labẹ omi tó ńṣàn." },
